...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('start_x', default_value='-5.5', description='X coordinate of starting position'),
        DeclareLaunchArgument('start_y', default_value='-15.0', description='Y coordinate of starting position'),
